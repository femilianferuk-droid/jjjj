...
# Инициализация бота
bot = Bot(token="ВАШ_ТОКЕН_ЗДЕСЬ")  # ← Замените на реальный токен
...
@dp.message_handler(state=AdminStates.waiting_for_button_name)
...
@dp.message_handler(state=AdminStates.waiting_for_button_url)
...
@dp.callback_query_handler(lambda c: c.data == "view_buttons")
...
@dp.callback_query_handler(lambda c: c.data == "remove_button")
...
@dp.message_handler(state=AdminStates.waiting_for_button_id_to_remove)
...
@dp.callback_query_handler(lambda c: c.data == "edit_button")
...
@dp.message_handler(state=AdminStates.waiting_for_button_id_to_edit)
...
@dp.message_handler(state=AdminStates.waiting_for_new_button_name)
...
@dp.message_handler(state=AdminStates.waiting_for_new_button_url)
...
@dp.callback_query_handler(lambda c: c.data == "edit_welcome")
